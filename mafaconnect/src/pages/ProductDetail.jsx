...
export default function ProductDetail() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      console.log("PRODUCT RESPONSE:", res.data.data); // you confirmed this
      return res.data.data; // product = object shown above
    },
    enabled: !!productid,
  });
  // console.log("producting ",product.stock_qty)
  // 🔄 Loading UI
  if (isLoading)
    return (
  ...
  if (isError || !product)
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground mb-4">Item may be removed.</p>
        <Button asChild>
  ...
  // 🟡 Stock Logic (now correct: shows 700000)
          ...
          <div className="flex items-center gap-4">
            ...
            {isLowStock && (
              <Badge variant="destructive">
                {isStaff ? `Only ${product.stock_qty} left!` : "Low Stock"}
              </Badge>
            )}
