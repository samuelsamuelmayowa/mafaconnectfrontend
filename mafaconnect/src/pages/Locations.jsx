    ...
    <div className="space-y-6">
      ...
      {overallMetrics && (
        <div className="grid gap-4 md:grid-cols-4">
          <MetricCard icon={Boxes} label="Products" value={overallMetrics.totalProducts} />
          <MetricCard icon={Package} label="Units" value={overallMetrics.totalUnits} />
          <MetricCard icon={TrendingUp} label="Stock Value" value={`₦${overallMetrics.totalValue.toLocaleString()}`} />
          <MetricCard icon={ShoppingCart} label="Sales (30d)" value={`${totalSales.count} orders`} extra={`₦${totalSales.total.toLocaleString()}`} />
        </div>
      )}
