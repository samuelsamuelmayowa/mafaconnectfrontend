...
const navigation = [
  ...
  { name: "Transactions", href: "/transactions", icon: Receipt, minLevel: 3 },
  ...
  { name: "Stock Transfers", href: "/stock-transfers", icon: ArrowRightLeft, minLevel: 3 },
  { name: "Suppliers", href: "/suppliers", icon: Truck, minLevel: 3 },
  { name: "Locations", href: "/locations", icon: MapPin, minLevel: 3 },
  { name: "Loyalty", href: "/loyalty", icon: Gift, minLevel: 3 },
  { name: "Analytics", href: "/analytics", icon: BarChart3, minLevel: 3 },
  { name: "Admin", href: "/admin", icon: Shield, minLevel: 2 },
];
...
export function DashboardLayout({ children }) {
  ...
  const NavContent = () => {
    ...
    //   return user.role_level <= item.minLevel;
      ...
      <nav className="flex flex-col gap-2">
        ...
        {isStaff && (
          <Link
            to="/portal"
            onClick={() => setOpen(false)}
            className="flex items-center gap-3 px-4 py-3 rounded-lg border border-dashed text-muted-foreground hover:bg-secondary hover:text-foreground"
          >
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="left" className="w-full sm:w-80 p-6">
              <div className="mb-8 flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold">MAFA Connect</h2>
              </div>
              <NavContent />
            </SheetContent>
          </Sheet>
          ...
          <div className="p-6 flex flex-col h-full">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-8">
                ...
                <h2 className="text-2xl font-bold">MAFA Connect</h2>
              </div>
            ...
            <div className="pt-4 border-t">
              <div className="mb-3">
                <Badge variant={roleVariant} className="text-xs capitalize">
                  {user.role.replace("_", " ")}
                </Badge>
              </div>
